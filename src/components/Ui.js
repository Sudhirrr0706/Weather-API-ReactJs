...
class Ui extends Component {
    ...
    render() {
        ...
        return (
        <React.Fragment>
            <div className="d-flex flex-wrap align-content-center container p-lg-4">
                <div className='card col-lg-8 col-12  mx-auto my-lg-5 bg-image'>
                       ...
                       <Animated animationIn='bounceIn'>
                        ...
                        <div class="card-body px-4">
                           ...
                           <Animated className="d-flex justify-content-between footer col-11" animationIn="slideInRight" animationOut="slideOutLeft"  isVisible={this.state.anime}>
                                    <div>
                                        <img className="icon mb-0 pb-0" src={this.state.iconUrl} alt=''/>
                                        <h4 class="card-title  my-auto cityName">{this.state.cityName} <span className="text-white text-muted"> {this.state.country}</span></h4>
                                    </div>
                                    <div className="col-lg-4 ">
                                        <h3 class="card-subtitle report d-flex align-items-end justify-content-end degree">{this.state.temp}{this.state.deg}</h3>
                                        <h5 className="weather mt-0 pt-0">{this.state.weatherReport}</h5>
                                    </div>
                           </Animated>
                ...
                <div className='section2 col-lg-4 col-12 my-lg-5'>
                    ...
                    <Animated animationIn="headShake" isVisible={this.state.animeError}>
